package com.pieapple.bleledlight;
...
import com.pieapple.bleledlight.example.MainActivity;
...
/*	
	private UUID targetServiceUuid = UUID.fromString("0000fff0-0000-1000-8000-00805f9b34fb");
    private UUID targetCharacterUuid = UUID.fromString("0000fff1-0000-1000-8000-00805f9b34fb");
    private UUID readUUID = UUID.fromString("0000fff4-0000-1000-8000-00805f9b34fb");
    */
	
	//private UUID targetServiceUuid = UUID.fromString("0000ffab-0000-1000-8000-00805f9b34fb");
	private UUID targetServiceUuid = UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb"); //for eric firmware
    private UUID targetCharacterUuid = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
    private UUID readUUID = UUID.fromString("0000ffe2-0000-1000-8000-00805f9b34fb");
	...
	public void getCharacteristic(List<BluetoothGattService> gattServices){
		Log.i("DEBUG_TAG", "call getCharacteristic");
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            Log.i("DEBUG_TAG", "gattService is "+uuid);
            if(uuid.equals(targetServiceUuid.toString())){
            //if(uuid.equals(targetServiceUuid.toString().equals("0000ffab-0000-1000-8000-00805f9b34fb"))) {
